...
- Full animated ASCII endings
- Pure single-page React with no build pipeline

## How to Run
Just download this repo (or visit the GitHub Pages link below) and open `index.html` in a browser.

## Future Plans
- Modularize engine logic
- Add AE scenarios
